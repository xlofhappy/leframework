 ...
 */
package com.qweather.leframework.generator.common.buffer;

import com.qweather.leframework.generator.common.utils.PaddedAtomicLong;
...
public class RingBuffer {
    ...
    public String toString() {
        ...
        builder.append("RingBuffer [bufferSize=").append(bufferSize).append(", tail=").append(tail).append(", cursor=").append(cursor).append(", paddingThreshold=").append(paddingThreshold).append("]");
