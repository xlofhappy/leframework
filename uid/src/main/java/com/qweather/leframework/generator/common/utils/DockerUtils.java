 ...
 */
package com.qweather.leframework.generator.common.utils;
...
public abstract class DockerUtils {
    ...
    private static void retrieveFromEnv() {
        ...
        if (Strings.isNullOrEmpty(DOCKER_PORT)) {
            DOCKER_PORT = System.getenv(ENV_KEY_PORT_ORIGINAL);
        }

        boolean hasEnvHost = !Strings.isNullOrEmpty(DOCKER_HOST);
        boolean hasEnvPort = !Strings.isNullOrEmpty(DOCKER_PORT);
